...
class INET_API AODVQoSRouting : public cSimpleModule, public ILifecycle, public INetfilter::IHook, public cListener
{
    ...
    protected:
        ...
        AODVQoSRREP *createRREP(AODVQoSRREQ *rreq, IRoute *destRoute, IRoute *originatorRoute, const L3Address& sourceAddr);
        ...
        void sendRREP(AODVQoSRREP *rrep, const L3Address& destAddr, unsigned int timeToLive);
