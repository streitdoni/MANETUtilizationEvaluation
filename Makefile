...
OBJS = $O/src/routing/AODVQoSRouteData.o $O/src/routing/AODVQoSRouting.o $O/src/routing/QoSRequirementsMapping.o $O/src/routing/AODVQoSControlPackets_m.o

# Message files
MSGFILES = \
    src/routing/AODVQoSControlPackets.msg
